...
const Notification = () => {
  ...
  return (
    <div className="w-full max-w-2xl mx-auto px-4 py-8 bg-[#f9f9f9] min-h-screen">
      <h1 className="text-2xl md:text-[2.75rem] font-semibold text-[#2d3435] mb-8 tracking-tight">
        Notifications
      </h1>

      <div className="space-y-6">
        <h2 className="text-[1.5rem] font-medium text-[#2d3435] mb-4">
          Follow Requests
        </h2>
            ...
            {followRequests.map((request) => (
              ...
              >
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 rounded-full overflow-hidden shrink-0 bg-[#ebeeef]">
                    <img
                  ...
                  <div className="flex flex-col">
                    <Link
                      ...
                      className="text-[0.875rem] font-semibold text-[#2d3435] hover:underline"
                    >
                      {request.follower.username}
                    </Link>
                    <span className="text-[0.875rem] text-[#5a6061]">
